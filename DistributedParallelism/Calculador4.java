...
public class Calculador4 {
    ...
    public static void main(String[] args) throws IOException, ClassNotFoundException {
        // recebe matrizes ///////////////////////////
        // matriz 11
        ServerSocket matriz_14 = new ServerSocket(6010);
        Socket socket = matriz_14.accept();
        ObjectInputStream leitor = new ObjectInputStream(socket.getInputStream());
        Matrix m14 = (Matrix) leitor.readObject();
        System.out.println("matriz 1 recebida:");
        for (double[] i : m14.getMatriz()){
            System.out.println(Arrays.toString(i));
        }

        //matriz 21
        ServerSocket matriz_24 = new ServerSocket(6011);
        Socket socket2 = matriz_24.accept();
        ObjectInputStream leitor2 = new ObjectInputStream(socket2.getInputStream());
        Matrix m24 = (Matrix) leitor2.readObject();
        System.out.println("matriz 2 recebida:");
        for (double[] i : m24.getMatriz()){
            System.out.println(Arrays.toString(i));
        }
        //////////////////////////////////////////////

        // multiplica as matrizes ////////////////////
        Matrix resultado = new Matrix(multiplicador(m14.getMatriz(),m24.getMatriz()));
        ...
        // envia as matrizes /////////////////////////
        Socket env_matriz_r = new Socket("localhost", 6303);
