...
public class Calculador2 {
    ...
    public static void main(String[] args) throws IOException, ClassNotFoundException {
        // recebe matrizes ///////////////////////////
        // matriz 11
        ServerSocket matriz_12 = new ServerSocket(6004);
        Socket socket = matriz_12.accept();
        ObjectInputStream leitor = new ObjectInputStream(socket.getInputStream());
        Matrix m12 = (Matrix) leitor.readObject();
        System.out.println("matriz 1 recebida:");
        for (double[] i : m12.getMatriz()){
            System.out.println(Arrays.toString(i));
        }

        //matriz 21
        ServerSocket matriz_22 = new ServerSocket(6005);
        Socket socket2 = matriz_22.accept();
        ObjectInputStream leitor2 = new ObjectInputStream(socket2.getInputStream());
        Matrix m22 = (Matrix) leitor2.readObject();
        System.out.println("matriz 2 recebida:");
        for (double[] i : m22.getMatriz()){
            System.out.println(Arrays.toString(i));
        }
        //////////////////////////////////////////////

        // multiplica as matrizes ////////////////////
        Matrix resultado = new Matrix(multiplicador(m12.getMatriz(),m22.getMatriz()));
        ...
        // envia as matrizes /////////////////////////
        Socket env_matriz_r = new Socket("localhost", 6301);
